...
try:
    ...
    if page == "Main Dashboard":
        ...
        with col_left:
            ...
            # --- PERFORMANCE BREAKDOWN (Idle টাইম লজিক সহ) ---
            ...
            # আপনার দেওয়া শিট ফর্মুলা অনুযায়ী Idle Time: MAX(0, (worked_days * 400) - total_time)
        ...
        with col_right:
            # আর্টিস্ট ডিটেইল সিলেকশন (অটো টপ আর্টিস্ট)
