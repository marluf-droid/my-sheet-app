...
try:
    ...
    if "Dashboard" in page:
        ...
        with m3: st.markdown(f'<div class="metric-card mrp-border m-card mrp-card">🟢 MRP AVG<br><h2>{calculate_man_day_avg(df, "Measurement Queue", "Live Job")}</h2></div>', unsafe_allow_html=True)
        ...
        tab1, tab2, tab3 = st.tabs(["📈 Overview & Trend", "👥 Team & Artist Summary", "🎨 Artist Deep-Dive"])
        ...
        with tab2:
            ...
            st.markdown("---")
            # --- ৫.২ PERFORMANCE BREAKDOWN (আর্টিস্ট সামারি - Unique) ---
        ...
        with tab3:
            # ইন্ডিভিজুয়াল আর্টিস্ট সিলেকশন ও বার চার্ট
            ...
            with col_a2:
                st.subheader("Individual Performance Detail Log")
                log_df = a_df.copy()
